        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('update-post', $post->id) }}" method="post" class="form-horizontal">
                    ...
                    <div class="col-12 col-md-9"><textarea name="content-post" id="content-post" rows="3" placeholder="Ex.: Preciso de uma ajuda em PHP" class="form-control" required>{{ $post->content }}</textarea></div>
                    </div>
                    <div class="row form-group">
